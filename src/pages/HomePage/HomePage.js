  ...
  <div className="home-elem-27">
            ...
            <div className="home-elem-36">
              <div className="home-elem-37">
                ...
                <span className="home-elem-39">
                    ...
                    set reminders for favorite events, follow exciting missions
                    and personalize your dashboard. Making space information
    ...
    <div className="home-elem-80">
      <div className="home-elem-81">
        ...
        <div className="home-elem-90">
          <div className="home-elem-84">
            {" "}
            <span className="cd-paragraph-clean home-elem-85">
              First name*
            </span>
            <input
              type="text"
        ...
        <div className="home-elem-89">
          {" "}
          <span className="cd-paragraph-clean home-elem-87">
            Email*
          </span>
          <input
            type="email"
        ...
        <div className="home-elem-96">
          {" "}
          <span className="cd-paragraph-clean home-elem-94">
            Phone number
          </span>
          <input
            type="text"
        ...
        <div className="home-elem-98">
          {" "}
          <span className="cd-paragraph-clean home-elem-97">
            Message*
          </span>
          <textarea
            placeholder="Message"
